class Recipe {
	constructor(authorParam, urlParam, isBasedOnParam, cookTimeParam, datePublishedParam, tagsParam, descriptionParam, imageParam, recipeIngredientParam, nameParam, prepTimeParam, recipeInstructionsParam, recipeYieldParam, ratingParam) {
		this.author = authorParam;
		this.url = urlParam;
		this.isBasedOn = isBasedOnParam;
		this.cookTime = cookTimeParam;
		this.datePublished = datePublishedParam;
		this.tags = tagsParam;
		this.description = descriptionParam;
		this.image = imageParam;
		this.recipeIngredient = recipeIngredientParam;
		this.name = nameParam;
		this.prepTime = prepTimeParam;
		this.recipeInstructions = recipeInstructionsParam;
		this.recipeYield = recipeYieldParam;
		this.rating = ratingParam;
	}

	getTagListHTML() {
		let HTML = `<li class="recipeTag">${this.tags[0]}</li>`;
		for (let i = 1; i < this.tags.length; i ++) {
			HTML = HTML + `<li class="recipeTag">${this.tags[i]}</li>`;
		}
		return HTML;
	}
		...
		const HTML = `
			<div class="recipeBlock">
				<div class="recipeImageBox">
                	<img class="recipeImage" src="${this.image}" alt="An image of the '${this.name}' dish." draggable="false">
                </div>
				<div class="recipeInfo">
                    <ul class="recipeTagList">
                        ${this.getTagListHTML()}
                    </ul>
                    <h2 class="recipeTitle">${this.name}</h2>
					<span class="recipeRating" role="img" aria-label="Rating: ${this.rating} out of 5 stars">
						${this.getRatingHTML()}
					</span>
...
const recipes = [
	...
	new Recipe(
		...
		'./images/escalopes-de-poulet-a-la-creme.webp',
		[
	...
	new Recipe(
		...
		'./images/black-beans-and-rice.jpg',
		[
	...
	new Recipe(
		...
		'./images/german-gooseberry-cake.jpg',
		[
			'For the Cake Base:',
		...
		'Gooseberry cake with vanilla cream and crumble',
		'30 min',
		[
